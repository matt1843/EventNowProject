...
public class CreateAccount extends Login implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonRegister = (Button) findViewById(R.id.create_btn);
        editTextEmail = (EditText) findViewById(R.id.emailttxt);
        editTextPass = (EditText) findViewById(R.id.passwordtxt);
